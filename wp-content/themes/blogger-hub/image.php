...
<main id="maincontent" role="main">
    <div class="container">
        <div class="main-wrap-box">
            ...
            if($blogger_hub_left_right == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9" id="wrapper">
                        <?php while ( have_posts() ) : the_post(); ?>    
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                ...
                                <?php edit_post_link( __( 'Edit', 'blogger-hub' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                            </article>    
                            <?php
            ...
            <?php }else if($blogger_hub_left_right == 'Right Sidebar'){ ?>
                <div class="row">
                    <div class="col-lg-9 col-md-9" id="wrapper">
                        <?php while ( have_posts() ) : the_post(); ?>    
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
